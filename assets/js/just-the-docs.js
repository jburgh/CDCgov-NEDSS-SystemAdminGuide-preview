...
function initSearch() {
  ...
  request.open('GET', '/CDCgov-NEDSS-SystemAdminGuide-preview/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/CDCgov-NEDSS-SystemAdminGuide-preview/assets/css/just-the-docs-' + theme + '.css');
}
